...
public class ObjWriter {
    ...
    public static String vertexToString(Vector3D vector) {
        return OBJ_VERTEX_TOKEN + " " + vector.get(0) + " " + vector.get(1) + " " + vector.get(2);
    }

    public static String textureVertexToString(Vector2D vector) {
        return OBJ_TEXTURE_TOKEN + " " + vector.get(0) + " " + vector.get(1);
    }

    public static String normalToString(Vector3D vector) {
